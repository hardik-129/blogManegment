...
function Blogdata() {
  ...
  useEffect(() => {
    ...
    axios
      .get(`https://blog-api-dev.octalinfotech.com/api/blogs/${id}/show`, {
  ...
  return (
    <>
      ...
      <div className="container  p-6 mx-auto  md:space-y-9 space-y-16">
        <div>
          <h1 className="text-4xl font-bold uppercase underline my-5">
            {user.category_name}
          </h1>
          <p className="flex items-center gap-4">
            ...
            On
            <h2 ><span className="text-gray-600 ">{user.date}</span></h2>
          </p>
          <div className="flex gap-2 border-b-[1px] py-5 flex-wrap">
            <div className="gap-2 flex items-center px-3  text-white btn text-sm py-1 bg-blue-800">
              <i class="fa-brands fa-facebook">
                <span className="px-2 uppercase ">Shere</span>
              </i>
            </div>
          ...
          <div className=" flex justify-evenly my-16">
            <div
              className="grid-cols-3 text-wrap mx-auto"
              style={{ width: "50%" }}
            >
              {text}
            </div>
          ...
          <div className="text-base text-start cursor-pointer mt-2 justify-start">
            ...
            <div className="flex justify-start items-center gap-2">
              ...
              <div className="flex gap-3">
                <span className="text-xs text-gray-900 ">{user.user_name}</span>
                <span className="text-xs text-gray-900">{user.date}</span>
              </div>
            </div>
