  ...
  return (
    <div  className="bg-gradient-to-r from-indigo-50">
      <header class="flex flex-wrap sm:justify-start sm:flex-nowrap w-full bg-white text-sm py-4 dark:bg-gray-800 border shadow-xl ">
        <div className="flex items-center gap-3 px-16">
          <div>
            <img
              ...
              src="https://blog-dev.octalinfotech.com/img/octal_infotech-logo_480.f7cd037c.png"
              alt=""
            />
          </div>
        ...
        <nav
          class="max-w-[85rem] w-full mx-auto px-4 flex flex-wrap basis-full items-center justify-center gap-16 "
          aria-label="Global"
        >
